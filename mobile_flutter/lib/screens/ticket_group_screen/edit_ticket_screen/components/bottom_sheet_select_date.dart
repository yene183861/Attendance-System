...
import '../../../../custom_widget/custom_calendar_picker.dart';
            ...
            children: [
              ...
              BlocBuilder<EditTicketBloc, EditTicketState>(
                  ...
                  builder: (context, state) {
                    return (Utils.formatDateTimeToString(
                                time: context.editTicketBloc.state.startDate!,
                                dateFormat:
                                    DateFormat(DateTimePattern.dayType1)) !=
                            Utils.formatDateTimeToString(
                                time: context.editTicketBloc.state.endDate!,
                                dateFormat:
                                    DateFormat(DateTimePattern.dayType1)))
              ...
              BlocBuilder<EditTicketBloc, EditTicketState>(
                ...
                builder: (context, state) => CustomCalendarPicker(
                  initialSelectedDate: widget.startDate
                      ? context.editTicketBloc.state.startDate!
                      : context.editTicketBloc.state.endDate!,
