    ...
    with tf.Graph().as_default():
        ...
        with tf.compat.v1.Session() as sess:
            ...
            if args.use_split_dataset:
                dataset_tmp = facenet.get_dataset(args.processed_dir)
                ...
                dataset = facenet.get_dataset(args.processed_dir)
            ...
            classifier_filename_exp = os.path.expanduser(args.clf_file)
