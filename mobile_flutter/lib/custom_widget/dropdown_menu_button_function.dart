...
class DropdownMenuButtonFuction extends StatefulWidget {
  ...
  @override
  State<DropdownMenuButtonFuction> createState() =>
      _DropdownMenuButtonFuctionState();
}

class _DropdownMenuButtonFuctionState extends State<DropdownMenuButtonFuction> {
              ...
              menuItemStyleData: MenuItemStyleData(
                  ...
                  customHeights: [
                    if (widget.datas.isNotEmpty)
                      (widget.datas.length >= 3
                          ? 150
                          : 50.0 * widget.datas.length)
                    else
                      0,
                    50
                  ]),
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            if (widget.itemInit.index == itemData.index)
              Container(
