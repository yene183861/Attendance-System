      ...
      onTap: () async {
        final value = await Navigator.of(context).pushNamed(
          ...
          arguments: EditAllowanceArgument(
            idOrganization:
                context.allowanceBloc.state.selectedOrganization!.id ?? 0,
                      ...
                      children: [
                        TextSpan(
                          text: allowance.amount == 0
                              ? '0'
                              : allowance.amount >= 10000000
                                  ? '${Utils.formatCurrency(amount: 100000000, context: context, format: NumberFormatPattern.vnCurrency)} +'
