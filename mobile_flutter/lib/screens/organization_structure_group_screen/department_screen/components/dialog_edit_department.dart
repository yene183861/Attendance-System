...
class DialogEditDepartment extends StatefulWidget {
  const DialogEditDepartment({
    super.key,
    required this.onTap,
    this.isAdd = false,
    this.text,
  ...
  @override
  State<DialogEditDepartment> createState() => _DialogEditDepartmentState();
}

class _DialogEditDepartmentState extends State<DialogEditDepartment> {
